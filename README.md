...
## Data Modeling
An Entity Relationship Diagram (ERD) was created to visualize the relationships among all tables and ensure proper data structure for analysis (image 1).
<div align="center">
...
Analysis of Data, Insight, Recommendation can see through file here:
```bash
...
## Dashboard
This link will lead you to looker studio to see the Dashboard Performance Analytics of Kimia Farma: Business Insight 2020-2023
[Looker Studio Report](https://lookerstudio.google.com/reporting/746d43b7-ef6e-4bc5-995a-634e0c437a08)
<div align="center">
  <img src="[https://github.com/user-attachments/assets/7e30c497-c965-458a-9fb7-4717e70d3de6](https://github.com/user-attachments/assets/9b8526c2-ca3c-44ff-9b2c-73fe2324077f)" width="400">
</div>
